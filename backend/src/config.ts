...
const db = {
  development: {
    ...
    connection: {
      database: Env.getString("DATABASE_DB", "movienight_development"),
  ...
  test: {
    ...
    debug: false,
    connection: {
      database: Env.getString("TEST_DATABASE_DB", "movienight_test"),
...
const secrets = {
  jwtSecret: Env.getString("JWT_SECRET", "movienight-secret"),
};
